...
class Xbar {
    ...
    public void searchDownward(Integer[][] xbar, Integer rowIndex, Integer columnIndex) {
        for(int i = rowIndex; i < numRows; i++) {
            //System.out.println("searchdown:"+ i+","+columnIndex);
            if ((i == numRows - 1)){
    ...
    public void searchleft(Integer[][] xbar, Integer rowIndex, Integer columnIndex) {
        for(int j = columnIndex; j >= 0; j--) {
            //System.out.println("searchleft"+ rowIndex+","+j);
...
class TruthTable {
    ...
    public void printTruthTableInputs() {
        for(Integer[] arr : truthTableInputs) {
...
//        String readPath = "bdds/var5.bdd";
//        BDD bdd = new BDD(readPath);
//        bdd.evaluateAllBddInstances();

        String readPath = "xbars/var2.xbar";
        String writePath = "xbar_results.txt";
        Xbar xbar = new Xbar(readPath);
        xbar.evaluateAllXbarInstances();
    }
}
